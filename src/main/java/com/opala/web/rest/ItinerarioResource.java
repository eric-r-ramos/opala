...
public class ItinerarioResource {
    ...
    public ResponseEntity<Itinerario> updateItinerario(@RequestBody Itinerario itinerario) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert("itinerario", itinerario.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Itinerario> getItinerario(@PathVariable Long id) {
        ...
        return Optional.ofNullable(itinerario)
    ...
    @Timed
    public List<Itinerario> searchItinerarios(@RequestParam String query) {
        log.debug("REST request to search Itinerarios for query {}", query);
        return StreamSupport
            .stream(itinerarioSearchRepository.search(queryStringQuery(query)).spliterator(), false)
